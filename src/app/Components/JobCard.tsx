  ...
  return (
    ...
    >
      <div className={divcls} style={{ marginLeft: "0px" }}>
        ...
        <h3 className="text-lg font-bold ml-4">{position}</h3>
      </div>
      <div className="flex items-center w-full mb-2">
        ...
        <div className="ml-auto flex flex-col items-center">
          <p className="text-black-500">{getTimeDifference(created_at)}</p>
          <div className="flex flex-col items-center mt-2">
            ...
            <button
              className="border border-gray-300 rounded-md px-2 py-2 w-32 mt-2"
              style={{ borderColor: "black" }}
