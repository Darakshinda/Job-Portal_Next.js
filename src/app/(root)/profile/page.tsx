          ...
          <ul className="mt-5 flex flex-col gap-y-3">
            <div className="flex flex-col gap-4">
              ...
              <Link
                ...
                className="flex items-center gap-2.5 group w-fit px-1.5 py-0.5 rounded-lg outline-none focus-visible:ring-2 focus-visible:ring-purple-600"
              >
                <FaGithub
                  size={20}
                  className="text-gray-500 group-hover:text-purple-600 cursor-pointer"
                />
                <p className="text-sm text-gray-500 underline group-hover:text-purple-600 group-hover:decoration-2 focus:outline-none focus:decoration-2">
                  GitHub
                </p>
              </Link>
              <Link
                href={profileData.linkedin || "#"}
                className="flex items-center gap-2.5 group w-fit px-1.5 py-0.5 rounded-lg outline-none focus-visible:ring-2 focus-visible:ring-blue-800"
              >
                <FaLinkedin
                  size={20}
                  className="text-gray-500 group-hover:text-blue-800 cursor-pointer"
                />
                <p className="text-sm text-gray-500 underline group-hover:text-blue-800 group-hover:decoration-2 focus:outline-none focus:decoration-2">
                  LinkedIn
                </p>
              </Link>
              <Link
                href={profileData.website || "#"}
                className="flex items-center gap-2.5 group w-fit px-1.5 py-0.5 rounded-lg outline-none focus-visible:ring-2 focus-visible:ring-gray-800"
              >
                <FaGlobe
                  size={20}
                  className="text-gray-500 group-hover:text-gray-800 cursor-pointer"
                />
                <p className="text-sm text-gray-500 underline group-hover:text-gray-800 group-hover:decoration-2 focus:outline-none focus:decoration-2">
                  Website
                </p>
              </Link>
            </div>
