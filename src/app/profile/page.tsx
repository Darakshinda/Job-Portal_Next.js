...
import primRole from './edit/data/primryRole.json';import expOpns from './edit/data/expOpns.json';import skillsOpns from './edit/data/skills.json';
...
const Home: React.FC = () => {
  ...
  return (
    <div className="bg-gray-900 max-w-[65%] mx-auto py-10 px-4 sm:px-6 lg:px-8">
