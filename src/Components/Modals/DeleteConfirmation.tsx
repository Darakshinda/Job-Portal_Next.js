          ...
          <div className="relative p-4 text-center bg-gray-100 rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div className="flex justify-center items-center space-x-4">
              <button
                ...
                type="button"
                className="py-2 px-3 text-sm font-medium text-gray-500 bg-gray-200 rounded-lg border border-gray-200 hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600"
              >
                No, cancel
              </button>
              <button
